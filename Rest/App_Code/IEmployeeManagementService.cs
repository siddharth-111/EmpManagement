...
namespace Rest
{
    ...
    public interface IEmployeeManagementService
    {
        ...
        List<DataObject.Employee> Retrieve(int PageSize, int CurrPage, string SortField, string SortDirection, string SearchString);
        ...
        DataObject.Employee RetrieveById(string EmployeeID);
        ...
        bool Create(DataObject.Employee employee);
        ...
        bool Edit(DataObject.Employee employee);
